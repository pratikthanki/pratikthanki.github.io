...
Something I have been working/ learning about the field of Computation the last few months. 
...
The formal definition of a context-free grammar is a 4-tuple `(V, Σ, R, S)` where;
