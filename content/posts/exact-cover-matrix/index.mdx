...
following methods. 
You can see the details in [Board.cs](https://github.com/pratikthanki/Revlos/blob/master/Revlos/Board.cs).
...
As Donald Knuth highlights, like a linked-list at any given Node we have "poiners" to the next and previous node. What makes 
